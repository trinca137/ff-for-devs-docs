...
>**Code**: REVENUES <br>
>**Type**: ```text``` <br>
><text class="aviso">❗ Obrigatório que esteja incluído no array (se o PERSON-TYPE for LEGAL).</text><br>
>
...
>   - **MINIMUM**<br>
><br>
>**Dependendo do tipo de categoria definido no campo CLASSIFICATION, o cálculo acontecerá de maneira diferente. Abaixo, você pode ver detalhadamente:**<br><br>
>
